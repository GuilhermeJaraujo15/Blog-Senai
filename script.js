...
const podcasts = [
    { button: document.getElementById('botao1'), audio: document.getElementById('pod1') },
    { button: document.getElementById('botao2'), audio: document.getElementById('pod2') },
    { button: document.getElementById('botao3'), audio: document.getElementById('pod3') },
];
